...
✅ **Clear grid-based layout** while still feeling immersive
✅ **More visually interesting** than pure top-down
✅ **Potential for depth** if I add environmental elements later.
...
3. **Deepening my understanding of game loops**—studying state machines and ECS to see if they fit my needs.
